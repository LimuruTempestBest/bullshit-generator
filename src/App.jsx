...
function App() {
  ...
  function problem() {
    ...
    if (select == 3) {
      ...
      if (subject == "" || bruh == "" || explain == "") {
        setparagraph("请输入内容,谢谢")
      }
      if (subject == "amongus" || bruh == "amongus" || explain == "amongus") {
        setparagraph("SUSUSUSUSUS")
      }
    }
  }
  ...
  return (
    <div className='bg-[#4E534D] p-10 w-full h-screen flex flex justify-center items-center relative'>
      <div className='flex flex-row gap-4 md:gap-36'>
        <div className='flex flex-col'>
          <div className='flex flex-row gap-2'>
            <div className="text-[#FFF1CC] text-xl md:text-4xl  animate__animated animate__zoomInDown animate__delay-1s">
              废
            </div>
            <div className="text-[#FFF1CC] text-xl md:text-4xl animate__animated animate__zoomInDown animate__delay-2s">
              话
            </div>
            <div className="text-[#FFF1CC] text-xl md:text-4xl animate__animated animate__zoomInDown animate__delay-1s">
              生
          ...
          <div className="mt-2 md:mt-5">
            <>
              {select == 2 ? (
                <>
                  <div className="text-lg md:text-2xl mt-4 md:mt-8 text-[#FFF1CC] paded animate__animated animate__fadeInLeft animate__delay-3s">主体</div>
                  <input
                    type="text"
                    placeholder="关羽" className='animate__animated animate__fadeInLeft animate__delay-3s text-stone-900 px-2 md:px-4 py-2 md:py-3 box-content w-32 md:w-72 text-lg md:text-2xl rounded font-medium border-2 border-[#27241F]'
                    value={subject}
                    onChange={(e) => setsubject(e.target.value)}
                  ></input>

                  <div>
                    <div className="mt-4 md:mt-8 text-lg md:text-2xl text-[#FFF1CC] paded animate__animated animate__fadeInLeft animate__delay-3s">事件</div>
                    <input
                      type="text"
                      placeholder="无语" className='animate__animated animate__fadeInLeft animate__delay-3s text-stone-900 px-2 md:px-4 py-2 md:py-3 box-content w-32 md:w-72 text-lg md:text-2xl rounded font-medium border-2 border-[#27241F]'
                      value={bruh}
                      onChange={(e) => setbruh(e.target.value)}
                    ></input>
                  </div>
                  <div>
                    <div className="mt-4 md:mt-8 text-lg md:text-2xl  text-[#FFF1CC] paded animate__animated animate__fadeInLeft animate__delay-3s">解释</div>
                    <input
                      type="text"
                      placeholder="他很无语" className='animate__animated animate__fadeInLeft animate__delay-3s text-stone-900 px-2 md:px-4 py-2 md:py-3 box-content w-32 md:w-72 text-lg md:text-2xl rounded font-medium border-2 border-[#27241F]'
                      value={explain}
                ...
                <>
                  <div className="text-lg md:text-2xl  mt-8 text-[#FFF1CC] paded animate__animated animate__fadeInLeft animate__delay-3s">主体</div>
                  <input
                    type="text"
                    placeholder="关羽" className=' animate__animated animate__fadeInLeft animate__delay-3s text-stone-900 px-2 md:px-4 py-2 md:py-3 box-content w-32 md:w-72 text-lg md:text-2xl rounded font-medium border-2 border-[#27241F]'
                    value={subject2}
          ...
          <div className="flex flex-row gap-5 mt-3 ">
            <div>
              <button
                onClick={() => setSelect(2)}
                className={`animate__animated animate__fadeInLeft animate__delay-3s bg-white rounded-sm w-14 md:w-20 h-10 flex items-center justify-center  ${select == 2 ? "border-2" : ""
                  } border-rose-300 text-xs md:text-base`}
              >
                营销号
              </button>
            </div>
            <div
              onClick={() => setSelect(3)}
              className={`animate__animated animate__fadeInLeft animate__delay-3s bg-white rounded-sm w-14 md:w-20 h-10 flex items-center justify-center  ${select == 3 ? "border-2" : ""
                } border-rose-300 text-xs md:text-base`}
            >
              <button>废话文学</button>
            </div>
          ...
          <div>
            <button className='animate__animated animate__fadeInLeft animate__delay-3s hover:bg-stone-400 duration-200 bg-stone-300 mt-5 md:mt-10 text-xl md:text-4xl bg-slate-300 p-2 md:p-3 rounded'
              onClick={() => {
                generate()
                problem()
              }} >
        ...
        <div className=' w-44 md:w-96  bg-[#27241F] text-[#FFF1CC] rounded-xl p-4 mt-24 text-md:text-lg animate__animated animate__fadeInLeft animate__delay-3s'>
          {paragraph}
        </div>
      </div>
    </div>
